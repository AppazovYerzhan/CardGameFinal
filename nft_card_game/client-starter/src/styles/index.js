const styles = {
  ...
  playerHealth: 'flex flex-row bg-white rounded-md p-2 sm:min-w-[103px] min-w-[63px] sm:min-h-[48px] min-h-[40px] bg-opacity-10 backdrop-filter backdrop-blur-lg mx-3',
